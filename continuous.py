...
from src.models.selfPlayContinuous import selfPlay
from src.models.targetContinuous import target
...
policy_alice = initNet(nnPolicy(2 * env.observation_space.shape[0], env.action_space.n + 1))
policy_bob = initNet(nnPolicy(2 * env.observation_space.shape[0], env.action_space.n))
